...
def welcome():
    ...
    return"""<html>
    <h2> * Step 2 Climate App / Home Page / List all the routes available * </h2>
    <img src="https://ucb.bootcampcontent.com/UCB-Coding-Bootcamp/UCBSF201905DATA2/raw/master/10-Advanced-Data-Storage-and-Retrieval/Homework/Images/surfs-up.png" width=667 height=295 />
    <ul>
    <br>
    <li>
